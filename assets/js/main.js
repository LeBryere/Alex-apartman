...
let svgI = svgW / 618; // 190 = viewBox="..X..X.190..X"
...
function openClose() {
   checkIn.style.color = (currentHour >= 15 && currentHour <= 21) ? "green" : "red";
   checkOut.style.color = (currentHour >= 7 && currentHour <= 10) ? "green" : "red";
}
